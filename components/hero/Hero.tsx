      ...
      <div className="relative mx-auto flex w-full max-w-6xl flex-col items-center text-center">
        <Reveal delay={0.05}>
          <p className="text-[13px] font-medium tracking-[0.02em] text-ink-tertiary">
            A personal operating system for iPhone
          </p>
        </Reveal>
        ...
        <Reveal delay={0.2}>
          <p className="mt-6 max-w-xl text-[17px] leading-relaxed text-ink-secondary sm:text-lg">
            LifeOS brings your home, finances, routines and priorities into one
            intelligent system that understands your life and helps you stay in
            control.
          </p>
        </Reveal>
