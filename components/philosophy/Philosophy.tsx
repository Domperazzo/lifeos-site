      ...
      <div className="mx-auto w-full max-w-4xl">
        <Reveal>
          <h2 className="text-[clamp(2rem,5.6vw,3.6rem)] font-semibold leading-[1.06] tracking-[-0.035em]">
            Software should adapt to your life.
            <span className="block text-ink-tertiary">Not the other way around.</span>
          </h2>
        </Reveal>
        ...
        <Reveal delay={0.12} className="mt-10 grid gap-6 sm:grid-cols-2 sm:gap-12">
          <p className="text-[17px] leading-relaxed text-ink-secondary">
            Most software asks you to keep it updated, organised and tidy. You
            end up maintaining the tool instead of the life it was supposed to
            help with.
          </p>
          <p className="text-[17px] leading-relaxed text-ink-secondary">
            LifeOS is built the other way round. It learns how your life
            actually works — your rooms, your money, your week — and keeps
            everything aligned, so the system does the remembering.
          </p>
        </Reveal>
      </div>
    </section>
