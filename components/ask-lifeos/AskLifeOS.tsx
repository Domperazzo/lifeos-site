  ...
  return (
    <Section>
      <div className="grid items-center gap-14 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.85fr)] lg:gap-20">
        <div>
          <SectionHeading
            eyebrow={t("Ask LifeOS")}
            title={t("Ask your life anything.")}
            lead={t("Not a chatbot with opinions. A system that already holds your accounts, your rooms and your week, answering from what it actually knows.")}
          />
